function formatDate(timestamp) {
  ...
  function displayTemperature(response) {
    ...
    iconElement.setAttribute(
      "src",
      `http://shecodes-assets.s3.amazonaws.com/api/weather/${response.data.condition[0].icon}/broken-clouds-day.png`
    );
  ...
  function search(city) {
    ...
    let apiUrl=`https://api.shecodes.io/weather/v1/current?query=Lisbon&apikey=${apiKey}`;
